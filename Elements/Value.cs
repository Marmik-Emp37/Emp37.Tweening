...
namespace Emp37.Tweening
{
      ...
      public class Value<T> : ITween
      {
            ...
            {
                  if (Phase is not (Phase.Active or Phase.Paused)) return;
...
#pragma warning restore IDE1006
            ...
            public override string ToString() => this.Summarize($"Delay: {delay:0.###}s | Progress: {progress:P0} | A: {a} - B: {b} | Duration: {1F / inverseDuration: 0.###}s | Ease: {easingMethod?.Method?.Name ?? "None"} | Mode: {timeMode}");
      }
}