...
#pragma warning restore IDE1006
            ...
            public override string ToString() => this.Summarize($"Target: {(linkedTarget == null ? "Destroyed" : linkedTarget.name)} | Delay: {delay:0.000}s | Progress: {progress:P0} | A: {a} - B: {b} | Duration: {1F / inverseDuration: 0.###}s | Ease: {easingMethod?.Method?.Name ?? "None"} | Mode: {timeMode}");
      }
}