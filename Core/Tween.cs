...
namespace Emp37.Tweening
{
      ...
      public static class Tween
      {
            ...
            public static Value<T> Value<T>(UObject link, Func<T> initialization, Func<T> target, float duration, Action<T> update, Value<T>.Evaluator evaluator) => Tweening.Value<T>.Fetch(link, initialization, target, duration, update, evaluator);
            ...
            public static Value<float> Value(UObject link, Func<float> initialization, Func<float> target, float duration, Action<float> update) => Value(link, initialization, target, duration, update, lerpF);
            ...
            public static Value<Vector2> Value(UObject link, Func<Vector2> initialization, Func<Vector2> target, float duration, Action<Vector2> update) => Value(link, initialization, target, duration, update, lerpV2);
            ...
            public static Value<Vector3> Value(UObject link, Func<Vector3> initialization, Func<Vector3> target, float duration, Action<Vector3> update) => Value(link, initialization, target, duration, update, lerpV3);
            ...
            public static Value<Vector4> Value(UObject link, Func<Vector4> initialization, Func<Vector4> target, float duration, Action<Vector4> update) => Value(link, initialization, target, duration, update, lerpV4);
            ...
            public static Value<Quaternion> Value(UObject link, Func<Quaternion> initialization, Func<Quaternion> target, float duration, Action<Quaternion> update) => Value(link, initialization, target, duration, update, lerpQ);
            ...
            public static Value<Color> Value(UObject link, Func<Color> initialization, Func<Color> target, float duration, Action<Color> update) => Value(link, initialization, target, duration, update, lerpColor);
