...
namespace Emp37.Tweening
{
      ...
      public static class TransformExtensions
      {
            ...
            {
                  Func<float> dst = relative ? () => transform.eulerAngles.x + target : () => transform.eulerAngles.x + Mathf.DeltaAngle(transform.eulerAngles.x, target);
            ...
            {
                  Func<float> dst = relative ? () => transform.eulerAngles.y + target : () => transform.eulerAngles.y + Mathf.DeltaAngle(transform.eulerAngles.y, target);
            ...
            {
                  Func<float> dst = relative ? () => transform.eulerAngles.z + target : () => transform.eulerAngles.z + Mathf.DeltaAngle(transform.eulerAngles.z, target);
            ...
            {
                  Func<float> dst = relative ? () => transform.localEulerAngles.x + target : () => transform.localEulerAngles.x + Mathf.DeltaAngle(transform.localEulerAngles.x, target);
            ...
            {
                  Func<float> dst = relative ? () => transform.localEulerAngles.y + target : () => transform.localEulerAngles.y + Mathf.DeltaAngle(transform.localEulerAngles.y, target);
            ...
            {
                  Func<float> dst = relative ? () => transform.localEulerAngles.z + target : () => transform.localEulerAngles.z + Mathf.DeltaAngle(transform.localEulerAngles.z, target);
