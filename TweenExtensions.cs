...
namespace Emp37.Tweening
{
      public static class TweenExtensions
      {
            ...
            #region U I
            public static Tween<float> TweenAlpha(this Graphic graphic, float target, float duration) => Tween.Create(() => graphic.color.a, target, duration, value => { Color c = graphic.color; c.a = value; graphic.color = c; });
