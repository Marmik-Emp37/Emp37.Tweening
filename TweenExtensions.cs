...
namespace Emp37.Tweening
{
	public static class TweenExtensions
	{
		...
		public static T SetLoops<T>(this T tween, int count, Loop.Type mode) where T : Tween { tween.setLooping(count, mode); return tween; }
		...
		public static T OnRetreat<T>(this T tween, Action callback) where T : Tween { tween.setOnRetreat(callback); return tween; }
		public static T OnLoopComplete<T>(this T tween, Action callback) where T : Tween { tween.setOnCycleComplete(callback); return tween; }
