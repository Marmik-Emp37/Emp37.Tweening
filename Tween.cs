...
namespace Emp37.Tweening
{
      ...
      public static class Tween
      {
            ...
            public static void Play<T>(this T element) where T : IElement => Factory.Add(element);
            ...
            public class Value<T> : IElement where T : struct
            {
                  ...
                  internal Value(Func<T> fetchValue, T target, float duration, Action<T> apply, Evaluator evaluator, UObject link = null)
                  {
                        b = target;
